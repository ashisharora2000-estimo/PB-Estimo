...
export const DEFAULT_TECHNICAL_INTEGRATIONS: TechnicalIntegrationItem[] = [
  ...
  },
  {
    id: 'int_09',
    code: 'INT-09',
    name: 'ADP / Ceridian Payroll Gross-to-Net Summary Journal Inbound',
    pillar: 'HCM',
    ...
    calculationFormula: '45h × 1.00 (Type) × 1.00 (Flow) × 1.20 (Mapping) × 1.15 (Protocol) × 1.15 (Volume) × 1.20 (Error) × 0.90 (API) = 78h',
    compositeScore: 1.67,
    rationale: 'Standard/Medium footprint (78 hrs). Bi-weekly gross-to-net payroll summary GL journals with labor cost center allocations.'
  },
  {
    id: 'int_10',
    code: 'INT-10',
    ...
    baseHours: 45,
    calculatedHours: 95,
    calculationFormula: '45h × 1.10 (Type) × 1.15 (Flow) × 1.20 (Mapping) × 1.15 (Protocol) × 1.50 (Volume) × 1.20 (Error) × 0.90 (API) = 95h',
    compositeScore: 1.83,
    rationale: 'Standard/Medium footprint (95 hrs). Scheduled incremental BICC VO extracts to enterprise Snowflake data lakehouse.'
  },
  {
    id: 'int_11',
    code: 'INT-11',
    ...
    baseHours: 45,
    calculatedHours: 58,
    calculationFormula: '45h × 1.00 (Type) × 1.00 (Flow) × 0.85 (Mapping) × 1.15 (Protocol) × 1.15 (Volume) × 1.20 (Error) × 0.90 (API) = 58h',
    compositeScore: 1.29,
    rationale: 'Simple/Standard footprint (58 hrs). Real-time merchant payment webhook settlement, interchange fee reconciliation, and automated AR cash receipt clearing.'
  },
  {
    id: 'int_12',
    code: 'INT-12',
    ...
    baseHours: 45,
    calculatedHours: 52,
    calculationFormula: '45h × 1.00 (Type) × 1.00 (Flow) × 0.85 (Mapping) × 1.15 (Protocol) × 0.90 (Volume) × 1.20 (Error) × 0.90 (API) = 52h',
    compositeScore: 1.16,
    rationale: 'Simple footprint (52 hrs). Capitalized IT hardware asset sync, asset commissioning, and retirement tracking.'
  },
  {
    id: 'int_13',
    code: 'INT-13',
    ...
    baseHours: 45,
    calculatedHours: 185,
    calculationFormula: '45h × 1.40 (Type) × 1.55 (Flow) × 1.70 (Mapping) × 0.90 (Protocol) × 1.15 (Volume) × 1.60 (Error) × 0.90 (API) = 185h',
    compositeScore: 2.53,
    rationale: 'Complex footprint (185 hrs). Global automated intercompany trade invoicing, transfer pricing margin adjustments, and currency revaluation handshakes.'
  },
  {
    id: 'int_14',
    code: 'INT-14',
    ...
    baseHours: 45,
    calculatedHours: 215,
    calculationFormula: '45h × 1.10 (Type) × 1.15 (Flow) × 1.70 (Mapping) × 1.45 (Protocol) × 1.50 (Volume) × 1.60 (Error) × 0.90 (API) = 215h',
    compositeScore: 2.62,
    rationale: 'Complex footprint (215 hrs). Multi-jurisdictional government-mandated XML audit extract with digital signatures and Peppol e-invoicing transmission.'
  }
];
